Action()
{
	...
	web_submit_data("login", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=username", "Value=debug_ilya008@group1.com", ENDITEM, 
		"Name=password", "Value=a123456A*", ENDITEM, 
	...
	web_custom_request("user_2", 
		...
		"Snapshot=t10.inf", 
		"Mode=HTML", 
		"Body={\"email\":\"debug_ilya008@group1.com\",\"id\":333,\"language\":\"RU\",\"notificationEnabled\":false}", 
		EXTRARES, 
	...
	web_custom_request("project", 
		...
		"Body={\"comment\":\"\",\"contentFormat\":\"yaml\",\"contentModelVersion\":\"2.0.0\",\"labelSet\":[],\"requestCount\":1,\"testType\":\"STABLE\",\"projectName\":\"debug_ilya008\",\"contentV2\":{\"boomqTestPlan\":{\"threadGroups\":[{\"boomqConfiguration\":{\"resourceConfiguration\":{},\"loadProfilePercent\":100},\"enabled\":true,\"id\":\"3b37ddbe-43c8-443d-9abb-b169553ab2b5\",\"label\":\"debug_ilya008\",\"steps\":[],\"type\":\"BOOMQ_STABLE_SCALABILITY\",\"typeDisplayName\":\"\",\"threadGroupElements"
		"\":[{\"children\":[{\"children\":\"\",\"individualProperties\":{\"useKeepAlive\":true,\"type\":\"HTTP\",\"retrieveAllEmbeddedResources\":true,\"followRedirects\":true,\"automaticallyRedirect\":false,\"method\":\"GET\",\"browserCompatibleHeaders\":false,\"doMultipartPost\":false,\"path\":\"/group1dummymock\",\"port\":\"48996\",\"protocol\":\"http\",\"search\":\"?\",\"serverName\":\"77.50.236.215\",\"headers\":{},\"queryParameters\":[],\"body\":\"\",\"bodyParameters\":[]},\"timerList\":[{\""
		"timerType\":\"CONSTANT\",\"label\":\"boomq_timer_d06b72f2-ca70-4d8c-9d37-fc6dedf62a40\",\"id\":\"d06b72f2-ca70-4d8c-9d37-fc6dedf62a40\",\"durationMs\":292000,\"enabled\":true}],\"label\":\"http://77.50.236.215:48996/group1dummymock\",\"id\":\"ffc18113-4b5b-4481-9fb1-a4c41f3cbc98\",\"type\":\"SAMPLER\",\"enabled\":true,\"assertions\":[],\"extractors\":[],\"typeDisplayName\":\"HTTP Request\"}],\"individualProperties\":{\"includeDurationOfAllElementsToGeneratedSampler\":false,\"generateParentSampler"
		...
		"responseTimeout\":120000}],\"loadProfile\":{\"usersPerStep\":1,\"rampDownMs\":0,\"durationAddedOnLastStepMs\":0,\"boomqProfileType\":\"STABLE\",\"rampUpMs\":0,\"stepLengthMs\":300000,\"stepCount\":1},\"timers\":[{\"timerType\":\"CONSTANT\",\"label\":\"boomq_timer_e6c295d9-bb7b-448f-addf-87e0bd6ee4ab\",\"id\":\"e6c295d9-bb7b-448f-addf-87e0bd6ee4ab\",\"durationMs\":8000,\"enabled\":true}]},\"slaGroupList\":[{\"type\":\"GENERAL_TEST_SLA\",\"targetType\":\"TEST\",\"slaList\":[{\"fromDate\":0,\""
		"restrictionType\":\"AVERAGE\",\"operation\":\"LESS_EQUALS\",\"status\":\"NOT_COUNTED\",\"toDate\":720,\"value\":\"3\"},{\"fromDate\":0,\"restrictionType\":\"ERROR_RATE\",\"operation\":\"LESS_EQUALS\",\"status\":\"NOT_COUNTED\",\"toDate\":720,\"value\":\"5\"},{\"fromDate\":0,\"restrictionType\":\"THROUGHPUT\",\"operation\":\"LESS_EQUALS\",\"status\":\"NOT_COUNTED\",\"toDate\":720,\"value\":\"0.01\"}]}],\"supportingFiles\":[],\"supportingFilesV2\":[]},\"totalDuration\":300}", 
		EXTRARES, 
	...
	web_custom_request("124", 
		...
		"responseTimeout\":120000}],\"loadProfile\":{\"usersPerStep\":1,\"rampDownMs\":0,\"durationAddedOnLastStepMs\":0,\"boomqProfileType\":\"STABLE\",\"rampUpMs\":0,\"stepLengthMs\":300000,\"stepCount\":1},\"timers\":[{\"timerType\":\"CONSTANT\",\"label\":\"boomq_timer_6fc7147e-35c4-46fa-841a-ef2f6522f249\",\"id\":\"6fc7147e-35c4-46fa-841a-ef2f6522f249\",\"durationMs\":8000,\"enabled\":true}]},\"slaGroupList\":[{\"type\":\"GENERAL_TEST_SLA\",\"targetType\":\"TEST\",\"slaList\":[{\"fromDate\":0,\""
		"restrictionType\":\"AVERAGE\",\"operation\":\"LESS_EQUALS\",\"status\":\"NOT_COUNTED\",\"toDate\":720,\"value\":\"3\"},{\"fromDate\":0,\"restrictionType\":\"ERROR_RATE\",\"operation\":\"LESS_EQUALS\",\"status\":\"NOT_COUNTED\",\"toDate\":720,\"value\":\"5\"},{\"fromDate\":0,\"restrictionType\":\"THROUGHPUT\",\"operation\":\"LESS_EQUALS\",\"status\":\"NOT_COUNTED\",\"toDate\":720,\"value\":\"0.01\"}]}],\"supportingFiles\":[],\"supportingFilesV2\":[]},\"totalDuration\":300}", 
		LAST);
